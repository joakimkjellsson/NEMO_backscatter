...
!  LOGICAL , PUBLIC ::   ln_dynldf_iso   !: iso-neutral direction                        (see ldfslp)
   LOGICAL , PUBLIC ::   ln_sgske        !: sub-grid scale kinetic energy reservoir 
   LOGICAL , PUBLIC ::   ln_kebs         !: KE backscatter
   ...
   REAL(wp), PUBLIC, ALLOCATABLE, SAVE, DIMENSION(:,:,:) ::   bhmt, bhmf   !: eddy viscosity for backscatter at T- and F-points [m2/s]
